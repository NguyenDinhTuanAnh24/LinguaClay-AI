    ...
    <header className="border-b-[3px] border-newsprint-black w-full relative z-50 bg-[#F5F0E8]">
      <div className="max-w-[1280px] mx-auto w-full px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`w-8 h-[3px] bg-black transition-all ${isMenuOpen ? 'rotate-45 translate-y-[9px]' : ''}`}></div>
            <div className={`w-8 h-[3px] bg-black transition-all ${isMenuOpen ? 'opacity-0' : ''}`}></div>
            <div className={`w-8 h-[3px] bg-black transition-all ${isMenuOpen ? '-rotate-45 -translate-y-[9px]' : ''}`}></div>
          </button>
        </div>
